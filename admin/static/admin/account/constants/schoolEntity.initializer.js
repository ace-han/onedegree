...
,function () {
    ...
    function init(nga, admin, moduleMenu, moduleBaseApiUrl, entityMap){
    	...
    	entity.listView()
	        .title('All schools') // default title is "[Entity_name] list"
	        .description('List of schools') // description appears under the title
    	...
    	moduleMenu
			.addChild(
					nga.menu(entity)
						.icon('<span class="fa fa-graduation-cap"></span>')
					);
